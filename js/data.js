...
(function (g) {
  ...
  APT.ROLES = {
    admin: { ten: 'Admin', user: 'admin', pages: '*', scope: 'both', home: 'tong-quan.html',
      ...
      act: { lap: true, duyetVP: true, duyetCuc: true, quanLy: true } },
    ctr: { ten: 'Lãnh đạo Cục 1 (LĐC1)', user: 'ctr', pages: ['tong-quan'].concat(ALL), scope: 'both', home: 'tong-quan.html',
      mota: 'Xem tất cả số liệu. Duyệt phiếu xuất kho ở bước Lãnh đạo Cục.',
      act: { duyetCuc: true } },
    pctr: { ten: 'Lãnh đạo Cục 2 (LĐC2)', user: 'pctr', pages: ['tong-quan'].concat(ALL), scope: 'both', home: 'tong-quan.html',
      mota: 'Xem tất cả số liệu. Duyệt phiếu xuất kho ở bước Lãnh đạo Cục.',
      act: { duyetCuc: true } },
    ...
    lsnn: { ten: 'Phòng LSNN', user: 'lsnn', pages: ['su-dung', 'tra-cuu', 'dieu-chuyen', 'chon-so'], scope: 'trong', home: 'dieu-chuyen.html',
      mota: 'Nhận và điều chuyển ấn phẩm trong nước, chọn số hộ chiếu, xem báo cáo sử dụng trong nước.',
      act: { lap: true } },
